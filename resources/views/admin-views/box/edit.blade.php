                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="time" name="pickup_time_from" value="{{ $box->pickup_time_from }}" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="input-label" for="pickup_time_to">{{ translate('messages.pickup_time_to') }}</label>
                                        <input type="time" name="pickup_time_to" value="{{ $box->pickup_time_to }}" class="form-control">
                                    </div>
                                </div>
                            </div>
                        </div>
