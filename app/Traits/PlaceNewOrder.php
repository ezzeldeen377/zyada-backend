            ...
            if ($c['item_type'] === 'App\Models\Box' || $c['item_type'] === 'AppModelsBox' || $c['item_type'] === 'Box' || $c['item_type'] === 'App\ModelsBox') {
                ...
                $or_d = [
                    ...
                    'item_details' => json_encode([
                        ...
                        'store_name' => $box->store->name ?? '',
                        'module_type' => $box->module->module_type ?? '',
                        'zone_id' => $box->store->zone_id ?? null,
                    ]),
                    'quantity' => $c['quantity'],
                    ...
                    'tax_amount' => 0,
                    'tax_status' => null,
                    'discount_on_product_by' => 'product_discount',
                    'discount_type' => 'product_discount',
                    'discount_on_item' => round($discount_amount, config('round_up_to_digit')),
                    'discount_percentage' => $box->discount_type === 'percent' ? $box->discount : 0,
                    'variant' => json_encode([]),
